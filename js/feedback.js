...
(function () {
    ...
    function createElements() {
        ...
        backdrop.innerHTML = [
            ...
            '        <input type="text" id="fb-name" class="feedback-input" placeholder="Your name (optional)" />',
            '      </div>',
            '      <div class="feedback-form-group">',
            '        <label for="fb-email">Your Email (optional)</label>',
            '        <input type="email" id="fb-email" class="feedback-input" placeholder="you@example.com (optional)" />',
            '      </div>',
            '      <div class="feedback-form-group">',
